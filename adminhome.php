...
<body>
    ...
    <div class="dashboard"> 
        ...
        <div class="nav-links">
            <a href="admin_dashboard.php"> <i class="bi bi-people"></i></i> Admin Panel </a>
    ...
    <div class="background"> 
        ...
        <button class="tab quiz1-tab" onclick="window.location.href='quiz.html'"><i class="bi bi-controller"></i>
            Quiz Now</button> 
        </div>
        <div class="button-main1">
        <button class="tab signin-tab"onclick="window.location.href='admin_dashboard.php'"> <i class="bi bi-people"></i> Sign In Now</button> 
        </div>
